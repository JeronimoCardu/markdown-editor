...
export default function DisplayMobile() {
  ...
  return (
    <div
      className={`${showDeleteModal && "backdrop-brightness-50 dark:backdrop-brightness-350"} h-screen w-full dark:text-gray-400`}
    >
      <section
        onClick={() => setViewPreview(!viewPreview)}
        className="dark:bg-black-700 absolute flex h-[2.5rem] w-full cursor-pointer items-center justify-between bg-gray-200 px-4 dark:text-gray-400"
      >
