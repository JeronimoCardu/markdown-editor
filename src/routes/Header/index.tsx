...
export default function Header() {
  return (
    <header className="bg-black-800 flex h-[4em] w-full justify-between pr-4">
      <button className="flex cursor-pointer items-center justify-center px-4">
      ...
      <div className="flex w-full items-center justify-start gap-3 px-4">
        ...
        <p className="headingM text-white">{data[1].name}</p>
      </div>
      <div className="flex items-center gap-6">
        ...
        <button className="bg-orange cursor-pointer rounded-[4px] p-3">
